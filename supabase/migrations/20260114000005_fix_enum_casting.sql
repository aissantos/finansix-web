-- Migration to Fix Enum Casting in explode_installments
-- Date: 2026-01-14
-- Error: column "status" is of type installment_status but expression is of type character varying
...
BEGIN
  ...
  IF NEW.credit_card_id IS NOT NULL THEN
      ...
      FOR i IN 1..NEW.total_installments LOOP
        ...
        -- FIX: Cast installment_status to installment_status enum
        VALUES (NEW.id, NEW.household_id, NEW.credit_card_id, i, NEW.total_installments, installment_amount, installment_amount_cents, billing_date, due_date, installment_status::installment_status, NOW(), NOW());
      END LOOP;
