-- Force recreation of explode_installments trigger with amount_cents support
-- This ensures the trigger from 20260110220000_fix_retroactive_installments.sql is active

DROP TRIGGER IF EXISTS trigger_explode_installments ON transactions;
DROP FUNCTION IF EXISTS explode_installments() CASCADE;
...
INCLUDES amount_cents field to comply with NOT NULL constraint.';
