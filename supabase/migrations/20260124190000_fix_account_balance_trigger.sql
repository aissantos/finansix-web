-- ============================================================================
-- Migration: Fix Account Balance Trigger
-- Date: 2026-01-24
-- Purpose: Create triggers to automatically update account balances
-- ============================================================================

-- Function to calculate and update the balance of a specific account
...
BEGIN
  ...
  SELECT 
    ...
    COALESCE(initial_balance * 100, 0) -- Approximate cents from initial if not stored (stored is better but consistent with logic)
...
-- Trigger function to call update_account_balance on transaction changes
